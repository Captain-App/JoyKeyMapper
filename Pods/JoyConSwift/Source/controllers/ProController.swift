...
public class ProController: Controller {
    ...
    override func readStandardState(value: IOHIDValue) {
        ...
        if button1 != 0 || button2 != 0 || button3 != 0 {
            NSLog("ProController Raw Buttons: %02X %02X %02X", button1, button2, button3)
        } else {
            // Optional: log occasionally even if 0 to confirm we are hitting this
            // NSLog("ProController buttons are zero")
        }
        */
